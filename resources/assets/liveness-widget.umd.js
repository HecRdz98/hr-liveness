...
/* TRIGGER BUTTON */
${e} .lv-trigger-btn { display: inline-flex; align-items: center; justify-content: center; gap: 10px; padding: 14px 26px; border: none; border-radius: 14px; cursor: pointer; font-family: var(--lv-font-body); font-size: 15px; font-weight: 600; letter-spacing: 0.15px; color: #fff; background: linear-gradient(135deg, var(--lv-primary) 0%, var(--lv-primary-dark) 100%); box-shadow: 0 6px 24px rgba(0,0,0,0.3), 0 1px 0 rgba(255,255,255,0.1) inset; position: relative; overflow: hidden; transition: transform 0.18s ease, box-shadow 0.18s ease; }
${e} .lv-trigger-btn::after { content: ''; position: absolute; inset: 0; background: linear-gradient(135deg, rgba(255,255,255,0.14) 0%, transparent 55%); pointer-events: none; }
