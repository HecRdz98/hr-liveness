...
/* MODAL */
${e} .lv-modal-backdrop { position: fixed; inset: 0; z-index: 9999; background: rgba(4,8,20,0.92); backdrop-filter: blur(8px); display: flex; align-items: center; justify-content: center; padding: 20px; opacity: 0; pointer-events: none; transition: opacity 0.25s ease; }
${e} .lv-modal-backdrop.open { opacity: 1; pointer-events: auto; }
${e} .lv-modal-close { position: absolute; top: 14px; right: 14px; z-index: 1; background: rgba(255,255,255,0.07); border: 1px solid rgba(255,255,255,0.12); color: var(--lv-text-muted); width: 36px; height: 36px; border-radius: 50%; cursor: pointer; font-size: 22px; line-height: 1; display: flex; align-items: center; justify-content: center; transition: background 0.2s,color 0.2s; font-family: sans-serif; }
${e} .lv-modal-close:hover { background: rgba(255,255,255,0.14); color: var(--lv-text); }
${e} .lv-modal-backdrop .lv-card { max-width: 420px; width: 100%; max-height: 92dvh; overflow-y: auto; position: relative; scrollbar-width: thin; scrollbar-color: rgba(255,255,255,0.1) transparent; }
...
@media (max-width: 520px) {
    ...
    ${e} .lv-modal-backdrop .lv-card { max-width: 100%; max-height: 96dvh; border-radius: 20px 20px 0 0; border-left: none; border-right: none; border-bottom: none; }
}
